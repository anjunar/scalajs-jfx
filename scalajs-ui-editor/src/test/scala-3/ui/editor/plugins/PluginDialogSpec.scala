...
final class PluginDialogSpec extends AnyFlatSpec with Matchers {
  ...
  "LinkPlugin dialog" should "compose its content through UI components" in {
  ...
  "ImagePlugin dialog" should "compose picker, preview and fields through UI components" in {
