...
The global UI layer for JFX 3: movable windows, anchor-following overlays, and timed notifications above the routed page.
...
```scala
libraryDependencies += "com.anjunar" %% "scalajs-jfx-viewport" % "3.0.5"
```
