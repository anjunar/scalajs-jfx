...
object WindowPageTranslations {
  val entries: Seq[CatalogEntry] = Seq(
    ...
    de(
      ...
      "Benachrichtigungen, Fenster und Overlays brauchen eine zentrale Ordnung. Scala JS UI 1.0 bündelt diese Belange im Viewport, sodass Seiten globale UI-Ebenen nicht selbst verwalten müssen."
    ),
