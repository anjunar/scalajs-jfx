        ...
        componentShowcase(
          ...
          hbox {
            ...
            vbox {
              ...
              div { classes = Seq("layout-shell-demo__brand"); text(i18n"Scala JS UI 1.0") {} }
            ...
            vbox {
              ...
              div {
                classes = Seq("layout-shell-demo__copy");
                text(
