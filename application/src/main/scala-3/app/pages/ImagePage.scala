        ...
        componentShowcase(
          ...
          hbox {
            ...
            image {
              ...
              alt = "A cute cat"
              style {
                borderRadius = "8px"; width = "200px"; height = "auto";
        ...
        componentShowcase(
          ...
          vbox {
            ...
            image {
              ...
              alt = currentAlt
              style {
                borderRadius = "50%"; width = "150px"; height = "150px"; objectFit = "cover";
                border = "3px solid var(--aj-accent)"
              }
            }
            hbox {
              style { gap = "10px" }
