...
final case class PositiveOrZero(message: String = "Must be positive or zero") extends StaticAnnotation
final case class Negative(message: String = "Must be negative") extends StaticAnnotation
final case class NegativeOrZero(message: String = "Must be negative or zero") extends StaticAnnotation
