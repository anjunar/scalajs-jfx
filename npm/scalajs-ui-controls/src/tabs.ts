/**
 * A tab strip. Mirrors `ui.control.tabs.Tabs`.
 *
 ...
 * TypeScript. `tabs` is a registry entry in `scalajs-ui-bridge` (`ControlFactories.scala`).
 */
import { component } from "@anjunar/scalajs-ui-core";
import type { ReadOnlyProperty } from "@anjunar/scalajs-ui-core";
