 ...
 * `ui.forms.ComboBox`.
 *
 * Its dropdown is an `@anjunar/scalajs-ui-viewport` `overlay`, so it needs a
 * `viewport(...)` ancestor -- the same requirement `ui.forms.ComboBox` has
 * on the Scala side.
 *
...
import type { ListProperty, ReadOnlyProperty } from "@anjunar/scalajs-ui-core";
