 ...
 * `ui.forms.Formular.FormSpec` only exercises the read direction, and
 ...
 * own context is how `FormFactories.arrayFormRenderer` (in `scalajs-ui-bridge`)
