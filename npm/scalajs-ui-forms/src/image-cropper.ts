 ...
 * bound by name like `input`. Mirrors `ui.forms.ImageCropper`. The value is
 * a {@link MediaValue}, translated at the boundary from `ui.forms.Media` --
 * see `MediaCodec` in `scalajs-ui-bridge`'s `FormFactories.scala`.
 *
