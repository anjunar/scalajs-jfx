# @anjunar/jfx-webauthn

The browser-side WebAuthn and passkey API for JFX 3. It is independent of the
JFX component runtime and is the TypeScript counterpart of
[`scalajs-jfx-webauthn`](../../jfx-webAuthn/README.md).

## Installation

```bash
npm install @anjunar/jfx-webauthn
```
...
```ts
import { authenticateJson, registerJson } from "@anjunar/jfx-webauthn";
