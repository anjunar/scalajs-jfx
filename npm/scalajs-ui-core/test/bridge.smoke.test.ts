 ...
 *
 * This file asserts exactly that, and no more: the three components scalajs-ui-bridge
...
// vitest runs with npm/scalajs-ui-core as the working directory (vitest.config.ts
