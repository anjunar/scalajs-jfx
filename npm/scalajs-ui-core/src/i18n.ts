 ...
 * recommendation, the TypeScript twin of `ui.core.i18n.i18n"..."` (`I18nInterpolator.scala`).
 *
...
/** Mirrors `ui.core.i18n.I18n.named`. Wrap every `i18n`/`i18nc` substitution in this. */
...
/** Mirrors `ui.core.i18n.i18n"..."`. Every substitution must be `named(name, value)`. */
...
/**
 * Mirrors `ui.core.i18n.i18nc"..."(context)` (`I18nInterpolator.scala`'s `i18nc`, whose two
 ...
 * `ui.core.i18n.I18n.entry(key).translations(...)`.
 *
 ...
 *
 * Nest a `router()` inside `body` to get locale-prefixed routes for free: `ui.router.Router`
