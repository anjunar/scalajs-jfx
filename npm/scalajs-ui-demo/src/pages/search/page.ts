 ...
 * directly -- page.ts may only import from @anjunar/scalajs-ui-* (CLAUDE_DEMO_PLAN.md
 * E-2). doc.ts builds `SearchEntry[]` from the real catalog and passes it in;
 * this function itself has no idea catalog.ts exists.
 */
import { attr, classes, div, element, forEach, li, on, property, text, ul } from "@anjunar/scalajs-ui-core";
