import { button, classes, div, listProperty, onClick, property } from "@anjunar/scalajs-ui-core";
import { arrayForm, form, input, inputContainer, Size, subForm } from "@anjunar/scalajs-ui-forms";
