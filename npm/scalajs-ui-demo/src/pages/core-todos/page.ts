...
import { i18n, locale, named, t } from "@anjunar/scalajs-ui-core";
import type { ComponentHandle, Disposable, Property, UiEvent } from "@anjunar/scalajs-ui-core";
import { translated } from "../../app/i18n.js";

/**
 * `input` has no typed wrapper in dsl.ts -- there is no `vbox`/`hbox`/`button`
 * for it, the way scalajs-ui-core deliberately keeps the wrapper set small.
