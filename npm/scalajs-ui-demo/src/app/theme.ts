import { attr, classes, div, disposeWith, domProperty, element, isBrowser, on, property, self, text, type ReadOnlyProperty } from "@anjunar/scalajs-ui-core";
import { createPreferences, designs, serverPreferences } from "@anjunar/scalajs-ui/preferences";
...
export function preferenceControls(url: string): void {
  const preferences = createPreferences("scalajs-ui-demo.theme", url);
