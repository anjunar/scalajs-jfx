...
import { renderToString, type HeadEntry, type SsrOptions } from "@anjunar/scalajs-ui-core";
...
export async function render(
  ...
  // `url: path` is how the complete request target reaches `ui.router.Router` on the
