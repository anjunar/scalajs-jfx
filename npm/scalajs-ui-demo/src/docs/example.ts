 ...
 * source that produced it (a `?ui-code` snippet, see code-block.ts), then
 * an optional note. See CLAUDE_DEMO_PLAN.md §4/E-3.
 */
import { classes, div, paragraph, text } from "@anjunar/scalajs-ui-core";
  ...
  div(() => {
    ...
    div(() => {
      ...
      div(() => {
        ...
        text(translated("The running component and its TypeScript source use the shared UI runtime."));
      });
    });
