/**
 * The token types a `?ui-code` import (tools/vite-plugin-ui-code.ts)
 ...
 */
import { button, classes, code, div, onClick, pre, property, span, text, when } from "@anjunar/scalajs-ui-core";
