...
for (const [api, destination] of [["scala", process.env.SCALA_DEMO_URL ?? "https://anjunar.github.io/scalajs-ui/scala/"], ["typescript", process.env.TYPESCRIPT_DEMO_URL ?? "https://anjunar.github.io/scalajs-ui/typescript/"]]) {
