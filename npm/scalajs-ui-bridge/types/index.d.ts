 ...
 * from `@anjunar/scalajs-ui-core` rather than restating it. That direction is
 * deliberate and matches the Scala side exactly: `uiBridge.dependsOn(uiCore)`
 ...
 * `@anjunar/scalajs-ui-core`'s own `src/bridge.d.ts`. That arrangement did not survive
 ...
 * the opposite.
 */
import type { UiRuntime } from "@anjunar/scalajs-ui-core";
 ...
 */
export declare const bridgeRuntime: UiRuntime;
