...
import ui.core.dsl.{AttributeDsl, ClassDsl, EventDsl, PropertyDsl, StyleDsl}
import ui.core.render.{CommentNode, Cursor, HostElement, HostNode, UiEvent, VirtualHost}
import ui.core.state.{CompositeDisposable, Disposable, ReadOnlyProperty}
...
abstract class AbstractComponent
  ...
  private[ui] var _host: HostNode                       = _
  private[ui] var _parent: Option[AbstractComponent]    = None
  private[ui] var _mountParentHost: Option[HostElement] = None
  private[ui] var _contentCursor: Cursor                = _

  /** This component's children.
    *
    * [[ui.core.component.Runtime]] owns them: `mount` adds an entry -- appended or at the supplied
    ...
    */
  private[ui] val _children      = mutable.ArrayBuffer.empty[AbstractComponent]
  private[ui] val disposables    = new CompositeDisposable()
  private[ui] val _contextValues = mutable.HashMap.empty[AnyRef, AnyRef]
  ...
  /** Does this component adopt server-rendered content during hydration without validating it,
    ...
    */
  private[ui] def adoptsHydratedContent: Boolean = false
