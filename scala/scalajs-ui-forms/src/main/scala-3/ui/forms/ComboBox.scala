...
import ui.control.table.{TableColumn, TableView}
...
final class ComboBox[T] private (
  ...
  override def compose(cursor: Cursor): Unit = {
    ...
    render(this, cursor) {
      addClass("ui-combo-box")
      classIf("ui-combo-box-open", openProperty)
      classIf("ui-combo-box-readonly", editableProperty.map(!_))
      ...
      div {
        classes = Seq("ui-combo-box__value")
        ...
        valueRendererProperty.get match {
          ...
          case None =>
            div {
              classes = Seq("ui-combo-box__value-text")
      ...
      div {
        classes = Seq("ui-combo-box__indicator", "material-icons")
      ...
      when(openProperty) {
        overlay(dropdownWidthProperty.get) {
          div {
            classes = Seq("ui-combo-box__dropdown")
            ...
            tableView[T](ComboBox.this.itemsProperty) {
              classes = Seq("ui-combo-box__table")
              ...
              column[T, Any]("") {
                ...
                TableColumn.cell { item =>
                  ...
                  div {
                    classes = Seq("ui-combo-box__item")
                    ...
                    itemRendererProperty.get match {
                      ...
                      case None =>
                        div {
                          classes = Seq("ui-combo-box__item-text")
            ...
            footerRendererProperty.get.foreach { renderer =>
              div {
                classes = Seq("ui-combo-box__footer")
                renderer
              }
            }
          }
